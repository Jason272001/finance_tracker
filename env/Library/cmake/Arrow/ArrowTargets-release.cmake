...
set_target_properties(Arrow::arrow_shared PROPERTIES
  IMPORTED_IMPLIB_RELEASE "D:/finance_tracker/env/Library/arrow.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/arrow.dll"
  )

list(APPEND _cmake_import_check_targets Arrow::arrow_shared )
list(APPEND _cmake_import_check_files_for_Arrow::arrow_shared "D:/finance_tracker/env/Library/arrow.lib" "${_IMPORT_PREFIX}/bin/arrow.dll" )
